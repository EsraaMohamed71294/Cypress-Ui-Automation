...
class MyAccount_PO extends Main_Base_PO{
    ...
    elements = {
        ...
        change_mobile_error     :() => cy.get('#errorDivNonemobile'),
        ...
        for (row of data_rows){
            ...
            switch(field){
                ...
                case 'Mobile Number':
                    ...
                    this.elements.phonenumber_field().type(value, { delay: 200 })
    ...
    get_mobile_otp(mobile){
        return cy.task('connectDB',`SELECT * FROM public."UserOtp" where "MobileNumber" like '%${mobile}'
    ...
    validate_name_error(text_key){
        // cy.log(this.elements.change_name_error().text())
    ...
    validate_mobile_error(text_key){
        cy.log(this.elements.change_mobile_error().invoke('text'))
        cy.log(super.get_value_by_key(text_key, this.config.language()))
